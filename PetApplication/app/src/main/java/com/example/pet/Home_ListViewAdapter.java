...
public class Home_ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ImageView photoImageView = (ImageView) convertView.findViewById(R.id.iv_petPhoto) ;
        final TextView nameTextView = (TextView) convertView.findViewById(R.id.tv_petName) ;
        final TextView detailTextView = (TextView) convertView.findViewById(R.id.tv_petDetail) ;
